...
const SignUp = () => {
  ...
  return (
    <div>
      <div>
        <div>
          <label className="mr-1 font-semibold font-md" htmlFor="admin">
            Admin
          </label>
          <input className="mr-2" type="radio" name="type" id="admin" />
          <label className="mr-1 font-semibold font-md" htmlFor="faculty">
            Faculty
          </label>
          <input className="mr-2" type="radio" name="type" id="faculty" />
          <label className="mr-1 font-semibold font-md" htmlFor="student">
            Student
          </label>
          <input className="mr-2" type="radio" name="type" id="student" />
        </div>
        <Formik
